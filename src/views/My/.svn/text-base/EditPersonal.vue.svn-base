    ...
    methods: {
                ...
                if(res.data.code == 0){
                    ...
                    for(let i=0;i<files.length;i++){
                        switch (files[i].file_desc) {
                            case '身份证正面':
                                this.showSZ = false;
                                this.szURL = files[i].file_url;
                                this.szFid = files[i].fid;
                                break;
                            case '身份证反面':
                                this.showSF = false;
                                this.sfURL = files[i].file_url;   
                                this.sfFid = files[i].fid;
                                break;
                            case '行驶证':
                                this.showXS = false;
                                this.xsURL = files[i].file_url;
                                this.xsFid = files[i].fid;
                                break;
                            default:
                                break;
                        }
        ...
        submit(){
            if(this.city == ''){
                ...
                console.log(`${this.szFid},${this.sfFid},${this.xsFid}`);
                return
                this.$http({
                    method: 'post',
