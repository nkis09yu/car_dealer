<template>
    <div class="collect">
        ...
        >
            <div class="list">
                <div @click="details(item)" v-for="(item, index) in historyList" :key="index" class="item">
                    <div class="top flex">
                        <van-image
...
export default {
    ...
    methods: {
        ...
        init(pageNum){
            this.$http({
                method: 'post',
                url: '/api/car_dealer_index.php?s=/Home/User/HistoryList',
            ...
            .then( res => {
                if(res.data.code == 0){
                    if(res.data.data.list.length == 0){
                        ...
                        this.historyList = [...this.historyList,...res.data.data.list];
                    }
                }else{
